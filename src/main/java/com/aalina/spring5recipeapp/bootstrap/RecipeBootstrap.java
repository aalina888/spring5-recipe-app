package com.aalina.spring5recipeapp.bootstrap;

import com.aalina.spring5recipeapp.domain.*;
import com.aalina.spring5recipeapp.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.getIngredients().add(new Ingredient("radishes, thinly slice", new BigDecimal(4), eachUom, tacosRecipe));
